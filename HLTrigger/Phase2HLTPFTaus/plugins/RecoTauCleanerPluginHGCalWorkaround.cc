...
double 
RecoTauCleanerPluginHGCalWorkaround::operator()(const reco::PFTauRef& pfTau) const 
{
...
DEFINE_EDM_PLUGIN(RecoTauCleanerPluginFactory, RecoTauCleanerPluginHGCalWorkaround, "RecoTauCleanerPluginHGCalWorkaround");
